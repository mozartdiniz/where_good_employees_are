...
/*
 * $Id: common.js 154638 2016-10-12 13:25:05Z gopi_borra $
...
(function($) {
    function handleSlideshowPromoImpression() {
        var slideshowList = $('body').find('.mediaOverlay.slideshow, .icon.slideshow');

        slideshowList.each(function () {
            var slideshowTitle;
            if ($(this).parents('.story').find("h5").length) {
                slideshowTitle = $(this).parents('.story').find("h5").text();
            } else {
                slideshowTitle = ($(this).parent('a').text()).replace("Slide Show: ", "");
            }
            trackingTrigger('slideshow-promo-impression',
                {
    ...
    function handleSlideshowPromoInteraction() {
        ...
        var iconLedeImageclick = icon.parents('.storyHeader').siblings().find('.image');

        $([mediaOverlay, mediaOverlayImageClick, mediaOverlayTitleClick, iconTitleClick, iconImageClick, iconLedeImageclick]).each(function() {
            $(this).on('click', function (e) {
                if ($(e.target).hasClass("mediaOverlay")) {
                    module              = "Icon";
                    mediaSlideshowTitle = $(this).parents('.story').find("h5").text();
                    ...
                    module              = "Image";
                    mediaSlideshowTitle = $(this).parents('.story').find("h5").text();
                    iconSlideshowTitle  = $(this).parents('.story').find("h3").text();
                    ledeSlideshowTitle  = $(this).parents().siblings('.storyHeader').find('a').text();
                    if (mediaSlideshowTitle.length) {
                        slideshowTitle = mediaSlideshowTitle;
    ...
    function callTrackingTrigger(module, slideshowTitle) {
        trackingTrigger('slideshow-promo-open',
            {
                'module': module,
                'pgtype': $("meta[name='PT']").attr('content'),
                'slideshowTitle': slideshowTitle.trim()
    ...
    */
    ...
    window.onload = function() {
        var isSectionFrontPage = ($('meta[name="PT"]').attr('content') === "Section Front");
